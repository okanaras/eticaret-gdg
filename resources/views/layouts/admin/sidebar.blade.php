                    ...
                    <ul class="nav sub-menu">
                        <li class="nav-item">
                            <a href="{{ route('admin.discount.index') }}"
                                class="nav-link {{ Route::is('admin.discount.index') || Route::is('admin.discount.show-products-list') || Route::is('admin.discount.show-categories-list') || Route::is('admin.discount.show-brands-list') ? 'active' : '' }}">Indirim
                                Listesi</a>
                        </li>
                        <li class="nav-item">
